...
/* This is the custom StimulusReflex controller for FileViewerReflex.
...
export default class extends ApplicationController {
   ...
   * Example:
   *
   *   <a href="#" data-reflex="FileViewerReflex#example">Example</a>
   *
   * Arguments:
   *
   ...
   *
   *   reflex - the name of the reflex e.g. "FileViewerReflex#example"
   *
