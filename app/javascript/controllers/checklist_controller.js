...
/* This is the custom StimulusReflex controller for ChecklistReflex.
...
export default class extends ApplicationController {
   ...
   * Example:
   *
   *   <a href="#" data-reflex="ChecklistReflex#example">Example</a>
   *
   * Arguments:
   *
   ...
   *
   *   reflex - the name of the reflex e.g. "ChecklistReflex#example"
   *
