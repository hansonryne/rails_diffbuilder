...
/* This is the custom StimulusReflex controller for SearchtermReflex.
...
export default class extends ApplicationController {
   ...
   * Example:
   *
   *   <a href="#" data-reflex="SearchtermReflex#example">Example</a>
   *
   * Arguments:
   *
   ...
   *
   *   reflex - the name of the reflex e.g. "SearchtermReflex#example"
   *
