...
/* This is the custom StimulusReflex controller for CreateGrepFromSelectionReflex.
...
export default class extends ApplicationController {
   ...
   * Example:
   *
   *   <a href="#" data-reflex="CreateGrepFromSelectionReflex#example">Example</a>
   *
   * Arguments:
   *
   ...
   *
   *   reflex - the name of the reflex e.g. "CreateGrepFromSelectionReflex#example"
   *
