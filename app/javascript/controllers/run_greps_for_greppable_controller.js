...
/* This is the custom StimulusReflex controller for RunGrepsForGreppableReflex.
...
export default class extends ApplicationController {
   ...
   * Example:
   *
   *   <a href="#" data-reflex="RunGrepsForGreppableReflex#example">Example</a>
   *
   * Arguments:
   *
   ...
   *
   *   reflex - the name of the reflex e.g. "RunGrepsForGreppableReflex#example"
   *
