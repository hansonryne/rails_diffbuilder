...
/* This is the custom StimulusReflex controller for UpdateLanguageRulesReflex.
...
export default class extends ApplicationController {
   ...
   * Example:
   *
   *   <a href="#" data-reflex="UpdateLanguageRulesReflex#example">Example</a>
   *
   * Arguments:
   *
   ...
   *
   *   reflex - the name of the reflex e.g. "UpdateLanguageRulesReflex#example"
   *
