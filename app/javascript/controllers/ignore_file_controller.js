...
/* This is the custom StimulusReflex controller for IgnoreFileReflex.
...
export default class extends ApplicationController {
   ...
   * Example:
   *
   *   <a href="#" data-reflex="IgnoreFileReflex#example">Example</a>
   *
   * Arguments:
   *
   ...
   *
   *   reflex - the name of the reflex e.g. "IgnoreFileReflex#example"
   *
